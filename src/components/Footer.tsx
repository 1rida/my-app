...
// import Image from 'next/image'; // Image is no longer needed
import { FaLinkedin, FaGithub } from 'react-icons/fa'; // Updated imports
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center"> {/* Centered content */}
          <div className="text-center"> {/* Centered text */}
            ...
            <div className="flex justify-center space-x-4 mt-2"> {/* Centered social links */}
